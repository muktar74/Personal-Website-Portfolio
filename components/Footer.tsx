...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', href: 'https://github.com/muktarabdella', icon: <GitHubIcon className="w-6 h-6" /> },
    { name: 'LinkedIn', href: 'https://linkedin.com/in/muktarabdella', icon: <LinkedInIcon className="w-6 h-6" /> },
    { name: 'Twitter', href: 'https://x.com/muktarabdella', icon: <TwitterIcon className="w-6 h-6" /> },
  ];
  ...
  return (
    <footer className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border-t border-zinc-200 dark:border-zinc-700">
      <div className="container mx-auto px-6 md:px-12 pt-12 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="md:col-span-2 flex flex-col items-center md:items-start">
            ...
            <p className="max-w-md text-zinc-700 dark:text-zinc-400 mb-6">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3">
              {quickLinks.map(link => (
                <li key={link.href}>
                  <a href={link.href} className="text-zinc-700 dark:text-zinc-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors">
                    {link.text}
                  </a>
                </li>
              ))}
      ...
      {/* Sub-footer */}
      <div className="bg-zinc-200 dark:bg-zinc-900 py-4 text-sm text-zinc-700 dark:text-zinc-400">
